...
class WallpaperScanner:
    ...
    NSFW_TAGS = {
        ...
        'sex', 'sexy', 'sensual', 'seductive', 'provocative', 'boudoir',
        'lingerie', 'bikini', 'underwear', 'swimsuit', 'cleavage',
        'naked', 'topless', 'bottomless', 'undressed', 'stripping', 'strip',
        'nsfw', 'nsfl', 'not safe for work', 'not safe for life',
        'porn', 'porno', 'pornstar', 'pornography', 'pornographic',
        'hardcore', 'softcore', 'xxx', 'adult content', 'adult only',
        'mature content', 'mature audience',
        'fetish', 'bdsm', 'kink', 'kinky', 'domination', 'submission',
        'bondage', 'discipline', 'sadism', 'masochism',
        'anal', 'oral', 'vaginal', 'penetration', 'intercourse',
        'masturbation', 'masturbate', 'cum', 'ejaculate', 'ejaculation',
        'semen', 'sperm', 'orgasm', 'climax',
        'dildo', 'vibrator', 'toy', 'toys', 'sex toy', 'sex toys',
        'blowjob', 'handjob', 'rimjob', 'deepthroat', 'fellatio', 'cunnilingus',
        'titfuck', 'tittyfuck', 'facial', 'bukakke', 'gangbang', 'orgy',
        'threesome', 'foursome', 'group sex', 'groupsex',
        'incest', 'step sister', 'step brother', 'step mom', 'step dad',
        'stepmother', 'stepfather', 'stepdaughter', 'stepson',
        'milf', 'dilf', 'cougar',
        'tentacle', 'tentacles', 'futanari', 'futa',
        'yaoi', 'yuri', 'shota', 'loli', 'shotacon', 'lolicon',
        'rule34', 'rule 34',
        'boobs', 'tits', 'titties', 'breasts', 'nipples', 'areola',
        'ass', 'asshole', 'butt', 'buttocks', 'anus', 'anal',
        'pussy', 'cunt', 'vagina', 'clit', 'clitoris', 'labia',
        'dick', 'cock', 'penis', 'phallus', 'shaft', 'balls', 'testicles',
        'scrotum', 'genitals', 'genitalia', 'pubic', 'pubes',
        'slut', 'whore', 'hooker', 'prostitute', 'escort',
        'bitch', 'bastard', 'cocksucker', 'motherfucker',
        'fuck', 'fucking', 'fucked', 'fucker',
        'shit', 'damn', 'asshole', 'bastard',
        'piss', 'pissing', 'pissed', 'urine', 'urination',
        'vomit', 'vomiting', 'gore', 'blood', 'bloody', 'violence',
        'guro', 'ryona',
    }
